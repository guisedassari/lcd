        ...
        <div class="inner">
            ...
            <div class="left pc-50">
                ...
                <div id="content">
                    ...
                    <p class="lighten left animate animated_THREE slideInRight">
                        <strong class="full">Missão</strong>
                        Superar as expectativas, entregando um serviço eficiente e com alta tecnologia. Construir relacionamentos de longo prazo, atuando com integridade e transparência. Melhorar e crescer, desenvolvendo colaboradores e investindo na empresa.
                    </p>
                    <p class="lighten left animate animated_THREE slideInRight">
                        <strong class="full">Visão</strong>
                        Ser referência em qualidade de serviços e equipamentos e a maior empresa de Produção Técnica de Eventos da região de Ribeirão Preto.
                    </p>
                    <p class="lighten left animate animated_THREE slideInRight">
                        <strong class="full">Valores</strong>
                        Integridade, transparência e compromisso;
                        Tecnologia, qualidade e eficiência;
                        Desenvolvimento e investimento.
                    </p>
                </div>
                <a id="top" class="pc-50 left button-top-down">
                    <i class="fa fa-arrow-up"></i>
                </a>
                <a id="bottom" class="pc-50 bl-0 left button-top-down">
